...
├── README.md
├── Concept_Baselines/
│   ├── LC-11_ATA-0000-GENERAL_BWB-CONFIG_V*.md
│   ├── LC-11_ATA-7100-POWERPLANT_PROPULSION-INTEGRATION_V*.md
│   └── LC-11_ATA-0000-GENERAL_SYSTEMS-ARCHITECTURE_V*.md
├── Trade_Studies/
│   ├── LC-11_ATA-0000-GENERAL_CONFIG-TRADES_V*.md
│   ├── LC-11_ATA-7100-POWERPLANT_PROPULSION-TRADES_V*.md
│   └── LC-11_ATA-0000-GENERAL_TECH-ASSESSMENT_V*.md
├── High_Level_Configurations/
│   ├── LC-11_ATA-5100-FUSELAGE_VEHICLE-GEOMETRY_V*.md
│   ├── LC-11_ATA-0000-GENERAL_MAJOR-SYSTEMS-LAYOUT_V*.md
│   └── LC-11_ATA-0000-GENERAL_INTEGRATION-CONCEPTS_V*.md
└── Mission_Performance_Envelopes/
    ├── LC-11_ATA-0000-GENERAL_MISSION-PROFILES_V*.md
    ├── LC-11_ATA-0000-GENERAL_PERFORMANCE-REQUIREMENTS_V*.md
    └── LC-11_ATA-2800-HYDROGEN_ENERGY-ANALYSIS_V*.md
```
